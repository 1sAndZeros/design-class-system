...
def test_read_entry_given_time():
    ...
    assert my_diary.read_entry_given_time(10,20) == 'This is my second diary entry which is longer'
...
def test_no_entries_to_read():
    ...
    entry2 = DiaryEntry('Entry Two', 'This is my second diary entry which is longer')
    my_diary.add(entry2)
    assert my_diary.read_entry_given_time(2,2) == 'There are no entries to read in the time given'
